...
- A compact content-sized listening card, up to 293×71.2 px, with 6 px horizontal and 8 px vertical padding, 20%-larger typography and optional cover artwork, no reserved cover gap when artwork is unavailable, and a 0.4-yalm nameplate safety height.
