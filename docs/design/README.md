...
The text block remains bottom-aligned with the artwork. Uniform 6 px padding keeps the cover, text, and artist line equally clear of every card border. Enlarging the title while retaining the 23 px line offset reduces its visual gap to the artist.
